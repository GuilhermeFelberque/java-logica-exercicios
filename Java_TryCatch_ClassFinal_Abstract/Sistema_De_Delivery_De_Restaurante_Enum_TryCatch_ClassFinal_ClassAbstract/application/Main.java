package Java_TryCatch_ClassFinal_Abstract.Sistema_De_Delivery_De_Restaurante_Enum_TryCatch_ClassFinal_ClassAbstract.application;


import Java_TryCatch_ClassFinal_Abstract.Sistema_De_Delivery_De_Restaurante_Enum_TryCatch_ClassFinal_ClassAbstract.entities.*;
    ...
    public static void main(String[] args) {
        ...
        if (autenticador.autenticar(emailInput, senhaInput)) {
            ...
            try {
                ...
                System.out.println("ERRO: Entrada inválida! Digite apenas números nas opções de escolha.");
            } finally {
                sc.close();
            }
